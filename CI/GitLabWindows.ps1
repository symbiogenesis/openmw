...
{
    cmake --build MSVC2019_64 --target openmw --config $Configuration -v -- -fileLogger "-fileLoggerParameters:LogFile=MSBuild.log;Append;Summary;Verbosity=diagnostic;Encoding=UTF-8;ShowTimestamp"
